...
### Design
![Screenshot of a tutoring site landing page I am making for my CS class](images/figmalandingpage.png)
### Key features
...
* If users create an account, their first name, last name, username, phone number, and password will be stored in the database. They will not have to reenter information on next booking once account is made.
### Technologies
...
* Completed all of the prerequisites
* Used Markdown properly using the Github documentation provided
...
* 3rd Party API call placeholder. Will most likely be using resend.com as my external API to send me an email
